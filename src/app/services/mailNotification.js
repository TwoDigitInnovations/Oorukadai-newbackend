...
module.exports = {
  ...
  MessageToCustomer: async ({ customerEmail, message }) => {
    try {
      ...
      `;
      await sendMailWithSubjectViaSendgrid(customerEmail, 'Message from Bach Hoa Houston Team', html)
      // return await sendMail(
      //   customerEmail,
  ...
  MessageToAllCustomer: async ({ name, customerEmail, message }) => {
    try {
      ...
      await sendMailWithSubjectViaSendgrid(customerEmail, 'Important Announcement from Bach Hoa Houston', html)
      // return await sendMail(
      //   customerEmail,
